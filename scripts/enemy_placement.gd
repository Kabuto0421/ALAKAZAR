...
enum EnemyKind { INFANTRY, MINER, HEAVY, CAVALRY, RECRUIT }
...
func _draw() -> void:
	var color: Color = [Color("bdc7c4"),Color("2bdcc8"),Color("ffbd59"),Color("8ab8ff"),Color("c6d4a0")][enemy_kind]
	draw_circle(Vector2.ZERO,22,Color("091314"))
	draw_circle(Vector2.ZERO,19,color)
	draw_circle(Vector2.ZERO,13,Color("172221"))
	var label: String = ["歩","地","重","跳","歩1"][enemy_kind]
